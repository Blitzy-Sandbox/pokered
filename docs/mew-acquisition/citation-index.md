...
| `ram/sram.asm:L12-21` | The `SRAM` "Save Data" section (`sGameData`/`sPlayerName`/`sCurBoxData`) — persists the save file and the Pokémon storage boxes; the disclosed save/box-corruption surface. | 03, glossary |
